...
| ---- | ------------- | ------------------ | -------------- | ------------- |
| Daniel V. Aleardi | 4.5 | 4.3125 | 4.4375 | 4.416666667 |
| Maisie Oliver | 4.388888889 | 4.388888889 | 4.388888889 | 4.388888889 |
| Titus Kurian | 4.15 | 4.25 | 4.15 | 4.183333333 |
...
* The presentation schedule will be finalized using a poll.  This is the official schedule as it stands now: [Presentation Schedule]({{site.baseurl}}/internship_presentation_schedule).
...
* Please review the [Course
  Introduction]({{site.baseurl}}/internships/pdfs/introduction-internship.pdf)
for presentation logistics.  Please review the [Lecture on
Presentations]({{site.baseurl}}/internships/pdfs/lecture-on-presentations-internship.pdf)
and the [Lecture on Assertion Evidence
Format]({{site.baseurl}}/internships/pdfs/lecture-on-assertion-evidence-format.pdf)
for tips on giving a good presentation.  
